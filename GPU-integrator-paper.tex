...
As will be discussed in Sec.~\ref{S:divergence}, this drop in performance is due to higher memory traffic requirements and increased levels of thread divergence.
...
Further, the Tesla C2075 GPU used in this study was originally released in 2011 and is several generations old, newer models have much larger L1 cache sizes and many more available registers.
...
This results from the increased memory traffic of the larger model (and subsequent increase in slow global memory load\slash stores), along with effects of thread divergence inside the internal integration step; this further motivates development of a sparse version of the \texttt{pyJac} software.
