...
The source code used in this work is freely-available~\cite{accelerInt:beta} and \ref{S:supp} presents the \LaTeX\ source files, validation and performance data, plotting scripts used in creation of this paper.
Finally,~\ref{S:raw} and~\ref{S:pasr_charac} provide unscaled plots of integrator runtimes and characterizations of the partially stirred reactor data for this work.
