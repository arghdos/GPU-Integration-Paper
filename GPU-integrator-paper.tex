...
To answer these questions, we attempt to derive a rough estimate of the number of CPU cores\slash GPUs required for equivalent performance.
...
\begin{itemize}
 ...
 \item For global time-step size relevant to Reynolds-averaged Navier--Stokes simulations, the GPU-based implicit Runga--Kutta solver performed equivalent to \texttt{CVODE} running on \num{14.7} cores for the \ce{H2}\slash\ce{CO} model, and just \num{3} cores for the GRI-Mech 3.0 model.
