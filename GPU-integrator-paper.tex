...
Thread divergence of such operations within a internal integration step could play an important role and will be investigated in our future work.
...
The \texttt{exprb43} thread divergence levels increase somewhat for the GRI-Mech 3.0 model with the smaller time-step size; \SI{27}{\percent} of warps still had a divergence measure of $D=0$, but nearly \SI{63}{\percent} of the warps had divergence measures between \numrange{0.05}{0.2}.
