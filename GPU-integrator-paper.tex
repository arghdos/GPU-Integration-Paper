...
Finally, the source code used in this work is freely-available~\cite{accelerInt:beta} and \ref{S:supp}, \ref{S:raw}, and \ref{S:pasr_charac} present supplementary data including \LaTeX\ source files, validation and performance data, plotting scripts, unscaled plots of integrator runtimes, and characterizations of the partially stirred reactor data used in this study.
