...
The \texttt{exprb43} solver reaches third order convergence with the ``exact'' Krylov subspace; it is unclear whether an order-reduction has occurred or this is due to numerical precision effects.
