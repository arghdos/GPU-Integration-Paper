...
Although a more accurate assessment of convergence order might be achieved through use of a stiff sample problem with an analytical solution---e.g., HIRES~\cite{wanner1991solving} or ROBER \cite{robertson1966solution}---direct validation with the problem at hand was conducted here.
