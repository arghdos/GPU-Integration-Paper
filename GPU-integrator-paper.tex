...
Correspondingly, speedups of $\sim\mathcal{O}(10\times$) are observed for both models with the smaller time-step, while the speedups for the \ce{H2}\slash\ce{CO} model with the larger time-step are much larger ($\sim\mathcal{O}(100\times)$).
