...
For example, a single high-resolution Lage Eddy Simumation (LES) realization of a diesel spray---using up to 22 million grid cells with a 54-species \emph{n}-dodecane model---for {\SI{2}{\milli\second}} after start of injection with the common implicit CVODE solver~\cite{cvode:2.8.2} took {\num{48000}} CPU core hours and up to {\num{20}} days of wall clock time~\cite{Moiz2016123}.
