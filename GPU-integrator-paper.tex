...
The expected order reduction of the \texttt{exp4} method is also apparent in Figs~\ref{F:exp4_div_h2} and \ref{F:exp4_div_ch4}, in which exhibits significantly more thread divergence than either of the other solvers for most cases.
