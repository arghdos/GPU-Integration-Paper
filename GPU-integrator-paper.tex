...
\begin{itemize}
 ...
 \item To achieve improved performance for larger chemical kinetic mechanisms on the GPU, a sparse analytical chemical kinetic Jacobian should be developed.
\end{itemize}
