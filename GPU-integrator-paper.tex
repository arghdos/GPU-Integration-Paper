...
The relatively worse stiffness handling of the \texttt{exp4} method is also apparent in Figs~\ref{F:exp4_div_h2} and \ref{F:exp4_div_ch4}, where significantly more thread divergence is seen for most cases than for either of the other solvers.
