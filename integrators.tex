...
The CPU \texttt{Radau-IIA} integrator was at best \SI{24.4}{\percent} faster than \texttt{CVODE} (at 2048 ODEs) and at worst \SI{16}{\percent} slower (at 32768 ODEs) for the smaller global time-step size.
In the best case for the larger global time-step, CPU \texttt{Radau-IIA} solver was \SI{3.7}{\percent} faster than \texttt{CVODE} (8192 ODEs) and \SI{91}{\percent} slower at worst (2048 ODEs).
