...
The GPU \texttt{Radau-IIa} integrator was at best $1.44\times$ slower than \texttt{CVODE}, and an average of $2.23\pm0.41\times$ slower for the smaller timestep (for more than 1000 ODEs, where the GPU becomes fully utilized).
