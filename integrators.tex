...
Methods to work around this issue were discussed along with the resulting balance between chemical kinetic mechanism size and independent ODEs solved per kernel launch.
...
\todo{If time, run Radau studies with $10^{-6}$ timestep for the $10^{-4}$ global timestep case to see effect on performance and emphasize this point}
