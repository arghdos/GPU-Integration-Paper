...
The implicit Runge--Kutta method performed up to eight times faster on a single GPU than \texttt{CVODE} on a single six-core CPU for an \ce{H2}\slash \ce{CO} model, and ran competitively with \texttt{CVODE} for the GRI-Mech 3.0 model.
...
Current efforts to accelerate of chemical kinetic integration techniques focus on improving the integration itself, via development of new algorithms and use of high-performance hardware accelerators such as GPUs and other similar SIMD devices.
