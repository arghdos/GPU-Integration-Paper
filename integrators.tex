...
In this work we will investigate GPU implementations of several semi-implicit and implicit integration techniques, as compared with their CPU counterparts and a baseline CPU VODE implementation~\cite{Hindmarsh:2005hg}.
...
\todo[inline]{If time, run Radau studies with 100 consecutive $10^{-6}$ time steps for the $10^{-4}$ global time step case to see effect on performance and emphasize this point}
