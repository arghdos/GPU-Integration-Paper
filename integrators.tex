...
The larger time-step size again negatively impacted the performance of the GPU-based \texttt{Radau-IIa} integrator, dropping the performance to $\SI{8.63}{\times}$ slower than \texttt{CVODE} in the best case, and $\SI{18\pm13}{\times}$ slower on average.
