...
\begin{figure}
  ...
  \end{subfigure}
  \caption{Average runtimes of the integrators for the \ce{H2} mechanism at two different global timesteps. CPU versions were run in parallel on 6-cores.}
  \label{F:H2_perf}
\end{figure}
...
For the larger timestep the performance of the GPU \texttt{Radau-IIa} integrator is again negatively impact as for the \ce{H2} mechanism, dropping to a best case of $8.63\times$ slower, and $14.18\pm6.64\times$ slower on average.
