...
The very small amount of available memory makes use in the integration algorithm itself challenging, however opportunities for use of the shared memory exist during evaluation of the chemical source terms and analytical Jacobian.
