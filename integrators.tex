...
In this section all the GPU results presented utilized the shared memory caching algorithm presented in Sec.~\ref{S:smem_present}, the benefit of which will be explored in Sec.~\ref{S:smem}.
